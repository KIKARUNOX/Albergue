  ...
  return (
    <Modal isOpen={isOpen} title="Agregar persona" onClose={cerrar}>
      <div className="stack-sm">
        <Label htmlFor="c-nombre">Nombre *<Input id="c-nombre" placeholder="Nombre" required minLength={2} value={form.nombre} onChange={onInputChange} /></Label>
        ...
        <Label htmlFor="c-cedula">Cedula *<Input id="c-cedula" placeholder="Cedula" required value={form.cedula} onChange={onInputCedula} /></Label>
        ...
        <Label htmlFor="c-salud">Estado de salud<Select id="c-salud" value={form.estado_salud} onChange={onSelectSalud}>
          <option value="">Seleccionar...</option>
          <option value="Sano">Sano</option>
          <option value="Enfermo">Enfermo</option>
        </Select></Label>
        <Label htmlFor="c-esc">Escolaridad<Select id="c-esc" value={form.escolaridad} onChange={onSelectEsc}>
          <option value="">Seleccionar...</option>
